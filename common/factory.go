...
func NewRabbit(name, ename, etype, rkey, mqurl string) (*RabbitMQ, error) {
	...
	//once.Do(func() {
	//	rq.Conn, err = amqp.Dial(rq.Mqurl)
	//	if err != nil {
	//		mes.FailOnError(err, "与RabbitMQ建立连接失败")
	//		return
	//	}
	...
	//		return
	//	}
	//	err = rq.Channel.ExchangeDeclare(ename, etype, true, false, false, false, nil)
	//	if err != nil {
	//		mes.FailOnError(err, "创建Exchanger失败")
	//		return
	//	}
...
func GetRabbitMQQueue(ctx context.Context, qname string) {
